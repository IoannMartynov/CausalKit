...
# `from causalkit.inference.ttest import ttest` works without duplicate files.
# We alias the existing module `causalkit.inference.atte.ttest` as a submodule of this package.
try:
