"""
Test for the CausalForestDML implementation for ATT estimation in causalkit.
"""
...
from causalkit.inference import causalforestdml_att


def test_causalforestdml_att():
    """
    Test the causalforestdml_att function with a simple example.
    """
    ...
    # Run CausalForestDML for ATT estimation
    results = causalforestdml_att(
        data=causal_data,
        n_estimators=100,
        max_depth=5,
        min_samples_leaf=5,
